...
export default function Navbar() {
    ...
    let menudata = [
        ...
        { Name: 'Sale!', href: "/Eyeglasses" },
        { Name: 'Catogries', href: "/About" }
    ]
    ...
    return (
        <div>
            <nav className='bg-white fixed w-full flex drop-shadow-md text-2xl justify-between items-center py-3 px-5 '>
